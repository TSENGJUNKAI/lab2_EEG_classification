...
def plot_train_acc(train_acc_list, epochs):
    ...
    plt.plot(range(1, epochs+1), train_acc_list, 'b-', label='Training Accuracy')
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy (%)')
...
def plot_train_loss(train_loss_list, epochs):
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(range(1, epochs+1), train_loss_list, 'r-', label='Training Loss')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
...
def plot_test_acc(test_acc_list, epochs):
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(range(1, epochs+1), test_acc_list, 'g-', label='Testing Accuracy')
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy (%)')
...
if __name__ == '__main__':
    ...
    train_data, train_label, test_data, test_label = dataloader_my.read_bci_data()
